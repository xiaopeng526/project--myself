...
export default {
  ...
  methods: {
    handleScroll() {
      this.visible =
        (document.querySelector(this.selector).scrollTop ||
          window.pageYOffset) > this.visibilityHeight;
    },
    backToTop() {
      if (this.isMoving) return;
      const start =
        document.querySelector(this.selector).scrollTop || window.pageYOffset;
      let i = 0;
